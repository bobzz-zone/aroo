...
def after_install():
	...
	url = "https://reg.aroo.co.id/api/method/my_account.my_account.doctype.custom_method.get_site_data?subdomain={}".format(subdomain)
	...
	frappe.db.commit()
	requests.get("https://reg.aroo.co.id/api/method/my_account.custom_dns_api.send_mail_site_created?subdomuser={}&fullname={}&newsitename={}".format(data['user'],data['fullname'],frappe.local.site))
